...
43,334 same-genus pairs sampled from GTDB R207 representative genomes, disjoint from the 2,541-pair v5 calibration training set (both directions excluded). Truth: nucmer/dnadiff ANIm. Methods: syn2bani raw gated estimate, syn2bani v5-calibrated estimate (true extrapolation), skani, FastANI.
...
| fastani | 43334 | 1.0449 | 0.8964 | -0.9827 | 0.8755 | 0.9819 |
...
| 95-100 | fastani | 404 | 0.3613 | -0.1993 | 0.6780 |
...
| Actinobacteriota | fastani | 11450 | 0.9068 | -0.8260 |
...
| Bacteroidota | fastani | 4359 | 1.2555 | -1.2158 |
...
| Campylobacterota | fastani | 476 | 0.7787 | -0.6506 |
...
| Firmicutes_A | fastani | 2521 | 1.1121 | -1.0567 |
...
| Firmicutes_C | fastani | 290 | 0.8944 | -0.8033 |
...
| Halobacteriota | fastani | 600 | 0.9321 | -0.6601 |
...
| Proteobacteria | fastani | 14555 | 1.0955 | -1.0436 |
...
| Spirochaetota | fastani | 382 | 0.9535 | -0.9254 |
...
| Thermoplasmatota | fastani | 231 | 1.0388 | -1.0345 |
...
| Thermoproteota | fastani | 304 | 1.2187 | -1.2098 |
...
| Verrucomicrobiota | fastani | 358 | 1.2723 | -1.2511 |
...
- FastANI non-call rate by band (NA rows):
  - 80-85: 0.0% (0/12172)
  - 85-90: 0.0% (0/16000)
  - 90-95: 0.0% (0/14758)
  - 95-100: 0.0% (0/404)
