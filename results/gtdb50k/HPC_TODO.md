...
| 5. Closed-genome control | **deferred** | Replaced by 7b; kept for reviewer response if needed. |
...
| 7b. Closed-genome cohort selection | **done** | 701 genomes selected; 680 fetched, 19 failed (NCBI path absent). All-vs-all Syn2b job 3979002 completed: 64,750 pairs, 61,537 OK. Report: `CLOSED_GENOME_INVERSION_REPORT.md`. |
| 8. FracMinHash scale 1582 | **done** | `syn2b_inverted_fraction_50k_fmh1582.tsv` written; z SD = 1.18 vs dnadiff truth. |
| 8b. FracMinHash scale 750 | **done** | `syn2b_inverted_fraction_50k_fmh750.tsv` written; r = 0.9305, z SD = 1.10. Sweep not needed. |
