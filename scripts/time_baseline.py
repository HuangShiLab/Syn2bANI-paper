#!/usr/bin/env python3
"""Time the baseline Syn2bANI binary on GTDB-R207 pairs."""
import time
...
if __name__ == '__main__':
    base = Path.home() / 'Downloads' / 'Syn2bANI' / 'target' / 'release' / 'syn2bani_baseline'
    time_s2b('results/pairs_gtdb_r207_100.tsv', str(base), threads=16)
    time_s2b('results/pairs_gtdb_r207_1k.tsv', str(base), threads=16)
