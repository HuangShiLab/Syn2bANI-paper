#!/bin/bash -l
#SBATCH --job-name=s2b_v6_mid_ani
...
#SBATCH --mem=64G
#SBATCH --time=2:00:00
#SBATCH --output=logs/s2b_v6_mid_ani_%j.out
#SBATCH --error=logs/s2b_v6_mid_ani_%j.err
...
OUTPUT_DIR="${PAPER_DIR}/results/validation/v6_mid_ani"
...
echo ""
echo "=== Step 2: Benchmark v6 on mid-ANI pairs ==="
cd "${PAPER_DIR}"
