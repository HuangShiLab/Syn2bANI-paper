#!/usr/bin/env python3
"""
Run one chunk of the v8 benchmark matrix on HPC.
Thin wrapper around run_benchmark_matrix_v8.py for job-array use.
"""
import argparse
import sys
...
from run_benchmark_matrix_v8 import main as matrix_main
