...
#SBATCH --time=4:00:00
#SBATCH --array=1-5
#SBATCH --output=logs/fastani_%A_%a.out
#SBATCH --error=logs/fastani_%A_%a.err
...
PAIRS_DIR=/lustre1/g/aos_shihuang/data/gtdb-r207/fastani_pair_chunks
OUT_DIR=/lustre1/g/aos_shihuang/data/gtdb-r207/fastani_chunks
...
# Run only FastANI on the stratified subset pairs
...
echo "FastANI task ${SLURM_ARRAY_TASK_ID} complete"
